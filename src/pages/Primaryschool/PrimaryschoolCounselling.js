...
import './PrimaryschoolCounselling.css'; // Home.css dosyasını dahil ediyoruz
...
function PrimaryschoolCounselling() {
        ...
        <section className="container pt-5 pb-5">
          ...
          <section className="corporate-section alt-background">
            ...
            <div className="text-content">
              ...
              <h2>{t('inclass_guidance_studies')}</h2>
              <p>{t('inclass_guidance_studies_main')}</p>
            </div>
          </section>
...
export default PrimaryschoolCounselling;
