...
import './HighschoolTwelfth.css'; // Home.css dosyasını dahil ediyoruz
import mainImage from '../../assets/12_MAIN_IMAGE.png'; // Resmin doğru yolu
import { useNavigate } from 'react-router-dom';
import FixedFooter from '../../components/FixedFooter';
function HighschoolTwelfth() {
      ...
      <section className="pt-2 pb-2 news">
        <div class="btn-toolbar d-flex justify-content-lg-around" role="toolbar" >
          <div class="btn-group button-width" role="group" aria-label="Third group">
            <button type="button" class="btn btn-purple-moon btn-rounded" onClick={() => window.open(process.env.PUBLIC_URL + '/pdfs/12. SINIF OKUL PDF-2.pdf', '_blank')}>{t('camp_and_season')}</button>
          </div>
          <div class="btn-group button-width" role="group">
            <button type="button" class="btn btn-purple-moon btn-rounded" onClick={() => window.open(process.env.PUBLIC_URL + '/pdfs/12. SINIF OKUL PDF-5.pdf', '_blank')}>{t('academic_calendar')}</button>
          </div>
          <div class="btn-group button-width" role="group">
            <button type="button" class="btn btn-purple-moon btn-rounded" onClick={() => window.open(process.env.PUBLIC_URL + '/pdfs/12. SINIF OKUL PDF-3.pdf', '_blank')}>{t('calendar')}</button>
          </div>
          <div class="btn-group button-width" role="group">
            <button type="button" class="btn btn-purple-moon btn-rounded" onClick={() => window.open(process.env.PUBLIC_URL + '/pdfs/12. SINIF OKUL PDF-4.pdf', '_blank')}>{t('mock_exam_club')}</button>
          </div>
          <div class="btn-group button-width" role="group">
            <button type="button" class="btn btn-purple-moon btn-rounded" onClick={() => window.open(process.env.PUBLIC_URL + '/pdfs/12. SINIF OKUL PDF-6.pdf', '_blank')}>{t('homework_system')}</button>
          </div>
          <div class="btn-group button-width" role="group">
            <button type="button" class="btn btn-purple-moon btn-rounded" onClick={() => window.open(process.env.PUBLIC_URL + '/pdfs/12. SINIF OKUL PDF-7.pdf', '_blank')}>{t('all_programs')}</button>
          </div>
        ...
        <section className="container pt-5 pb-5">
          ...
          <div className="row">
            <div className="col-lg-6 col-sm-12 mb-5">
              <h1 className="pb-3 text-center">{t('twelfthgrade')}</h1>
              <h2>{t('highschool_sub')}</h2>
              <div className="text-list">
                <p>{t('highschool_twelfth_main_1')}</p>
                <p>{t('highschool_twelfth_main_2')}</p>
                <p>{t('highschool_twelfth_main_3')}</p>
                <p>{t('highschool_twelfth_main_4')}</p>
                <p>{t('highschool_twelfth_main_5')}</p>
                <p>{t('highschool_twelfth_main_6')}</p>
                <p>{t('highschool_twelfth_main_7')}</p>
                <p>{t('highschool_twelfth_main_8')}</p>
                <p>{t('highschool_twelfth_main_9')}</p>
              </div>
            </div>
...
export default HighschoolTwelfth;
