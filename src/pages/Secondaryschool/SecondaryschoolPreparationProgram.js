...
import './SecondaryschoolPreparationProgram.css'; // Home.css dosyasını dahil ediyoruz
import mainImage from '../../assets/Rules.gif'; // Resmin doğru yolu
import { useNavigate } from 'react-router-dom';
import FixedFooter from '../../components/FixedFooter';
function SecondaryschoolPreparationProgram() {
        ...
        <section className="container pt-5 pb-5">
          ...
          <div className="row">
            <div className="col-lg-6 col-sm-12 mb-5">
              <h2 className="pb-3 text-center">{t('preparation_program')}</h2>
              <p><strong>{t('secondaryschool_preparation_program_header')}</strong></p>
              <p>{t('secondaryschool_preparation_program_main_1')}</p>
              <p>{t('secondaryschool_preparation_program_main_2')}</p>
              <p>{t('secondaryschool_preparation_program_main_3')}</p>
              <p>{t('secondaryschool_preparation_program_main_4')}</p>
              <p>{t('secondaryschool_preparation_program_main_5')}</p>
              <p>{t('secondaryschool_preparation_program_main_6')}</p>
              <p>{t('secondaryschool_preparation_program_main_7')}</p>
              <p>{t('secondaryschool_preparation_program_main_8')}</p>
            </div>
...
export default SecondaryschoolPreparationProgram;
