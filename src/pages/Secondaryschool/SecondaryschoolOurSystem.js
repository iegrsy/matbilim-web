...
import './SecondaryschoolOurSystem.css'; // Home.css dosyasını dahil ediyoruz
import oursystem_main_1 from '../../assets/oursystem_main_1.png'; // Resmin doğru yolu
import oursystem_main_2 from '../../assets/oursystem_main_2.png'; // Resmin doğru yolu
import { useNavigate } from 'react-router-dom';
import FixedFooter from '../../components/FixedFooter';
function SecondaryschoolOurSystem() {
        ...
        <section className="container pt-5 pb-5">
          <div className="row">
            <div className="col-lg-6 col-sm-12 mb-5">
              ...
              <p><strong>{t('secondaryschool_oursystem_header')}</strong></p>
              <p>{t('secondaryschool_oursystem_main_1')}</p>
              <p>{t('secondaryschool_oursystem_main_2')}</p>
              <p>{t('secondaryschool_oursystem_main_3')}</p>
              <p>{t('secondaryschool_oursystem_main_4')}</p>
              <p>{t('secondaryschool_oursystem_main_5')}</p>
            </div>

            <div className="col-lg-6 col-sm-12">
              <img src={oursystem_main_1} alt="MatBilim Logo" className="img-fluid" />
            </div>
          </div>
          <section className="corporate-section alt-background">
            <div className="image-content">
              <img src={oursystem_main_2} alt="MatBilim Logo" className="img-fluid" />
            </div>
...
export default SecondaryschoolOurSystem;
