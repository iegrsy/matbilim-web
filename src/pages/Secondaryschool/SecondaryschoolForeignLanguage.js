...
import './SecondaryschoolForeignLanguage.css'; // Home.css dosyasını dahil ediyoruz
import mainImage from '../../assets/foreign.gif'; // Resmin doğru yolu
import { useNavigate } from 'react-router-dom';
import FixedFooter from '../../components/FixedFooter';
function SecondaryschoolForeignLanguage() {
        ...
        <section className="container pt-5 pb-5">
          ...
          <div className="row">
            <div className="col-lg-6 col-sm-12 mb-5">
              <h2 className="pb-3 text-center">{t('foreign_language')}</h2>
              <p><strong>{t('secondaryschool_foreignlanguage_header')}</strong></p>
              <p>{t('secondaryschool_foreignlanguage_main_1')}</p>
              <p>{t('secondaryschool_foreignlanguage_main_2')}</p>
              <p>{t('secondaryschool_foreignlanguage_main_3')}</p>
              <p>{t('secondaryschool_foreignlanguage_main_4')}</p>
            </div>
...
export default SecondaryschoolForeignLanguage;
